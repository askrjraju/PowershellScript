...
Add-VpnS2SInterface -Protocol IKEv2 -AuthenticationMethod PSKOnly -NumberOfTries 3 -ResponderAuthenticationMethod PSKOnly -Name "52.172.34.135" -Destination "52.172.34.135" -IPv4Subnet @("192.168.0.0/24:100") -SharedSecret "a1b2c3"
Set-VpnServerIPsecConfiguration -EncryptionType MaximumEncryption

Set-VpnS2Sinterface -Name "52.172.34.135" -InitiateConfigPayload $false -Force

# Set S2S VPN connection to be persistent by editing the router.pbk file (required admin priveleges)
Set-PrivateProfileString $env:windir\System32\ras\router.pbk “52.172.34.135” "IdleDisconnectSeconds" "0"
Set-PrivateProfileString $env:windir\System32\ras\router.pbk "52.172.34.135" "RedialOnLinkFailure" "1"

# Once Conncetion DOne run below command
Restart-Service RemoteAccess
Connect-VpnS2SInterface -Name 52.172.34.135