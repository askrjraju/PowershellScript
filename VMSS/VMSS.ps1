...
$Subnet1 = New-AzureRmVirtualNetworkSubnetConfig -Name $subnetname -AddressPrefix 10.3.0.0/24
$vnetName = "CRMVET"
$vnet = New-AzureRmVirtualNetwork -Name $vnetName -ResourceGroupName $RgName -Location $location -AddressPrefix 10.3.0.0/24 -Subnet $Subnet1
...
$lbrule = New-AzureRmLoadBalancerRuleConfig -Name $LBrulename -FrontendIpConfigurationId $FrontendIPconfig.Id -BackendAddressPoolId $BackendaddressPool.Id -ProbeId $Probe.Id -Protocol Tcp -FrontendPort 443 -BackendPort 443 -IdleTimeoutInMinutes 15
