...
Select-AzureRmSubscription -SubscriptionId 2606bde4-1f00-4862-961c-70f8d9451c90
...
################################################ Copy Vhd ###################################################################
Select-AzureSubscription -Subscriptionid 1ef3d826-ff60-4269-92c1-050346838a98 
$vmname = "classvm"
...
$Nic=New-AzureRmNetworkInterface -Name $NicName -ResourceGroupName $ResourceGroupName -Location $Location -SubnetId $SubnetID -PrivateIpAddress 10.220.1.4
...
{
$srcdduri = $dd.MediaLink.AbsoluteUri[$i]
$destddname = $ddnames[$i] +".vhd"
